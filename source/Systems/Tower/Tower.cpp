...
void Tower::AddModelsIn(StaticModelSystem::InitData& staticModelData)
{
	...
	adventure.Path = L"T_Adventure_01.png";

	Model& village3{ adventure.Models.AddEmpty() };
	village3.Path = L"M_Village_03.fbx";
	...
	drapes.Path = L"M_Village_WindowDrapes_01.fbx";
	...
	knights.Path = L"T_Knights_01.png";

	Model& stairs{ knights.Models.AddEmpty() };
	stairs.Path = L"M_Rockwall_Stairs_01.fbx";
	...
	western.Path = L"T_Western_01_A.png";

	Model& ladder{ western.Models.AddEmpty() };
	ladder.Path = L"M_Ladder_01.fbx";
